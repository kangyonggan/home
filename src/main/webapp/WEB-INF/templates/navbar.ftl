<nav class="navbar navbar-fixed-top">
    ...
    <div class="pull-left hidden-sm">
        <ul class="nav-list">
            <li><a href="${ctx}/article/category/original">原创博客</a></li>
            <li><a href="${ctx}/article/category/course">图文教程</a></li>
            <li><a href="${ctx}/article/category/note">学习笔记</a></li>
            <li><a href="${ctx}/article/category/code">代码片段</a></li>
            <li><a href="${ctx}/article/category/other">杂记</a></li>
        </ul>
    </div>
